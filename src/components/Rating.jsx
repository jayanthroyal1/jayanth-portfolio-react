  ...
  return (
    <section id="rating" className="py-20 px-8 max-w-7xl mx-auto text-white">
      ...
      <p className="text-xl mb-10 text-center text-black">
        Hi everyone, could you share some feedback on my skills and recent
        performance? I’d really appreciate your input to help me improve.
      </p>
      ...
      <div className="flex flex-col md:flex-row md:space-x-10 space-y-10 md:space-y-0">
        ...
        <div className="flex-1">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {ratings
              .slice() // create a copy
              .reverse() // latest review first
              .map((item, i) => (
                <div
                  key={i}
                  className="bg-gray-800 p-5 rounded-xl shadow-lg
                     hover:shadow-2xl hover:-translate-y-2 hover:scale-105
                     transition-transform cursor-pointer animate-fadeInSlow"
                >
                  {/* Avatar + Name */}
